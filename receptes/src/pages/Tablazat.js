        ...
        <div className="mainwindow-parent2">
          ...
          <div className="row">
            ...
            <div className="component-28">
              <div className="component-27-child" />
              <div className="alapanyag1">energia</div>
            </div>
            <div className="component-29">
              <div className="component-27-child" />
              <div className="alapanyag2">feherje</div>
            </div>
            <div className="component-30">
              <div className="component-27-child" />
              <div className="alapanyag3">zsir</div>
            </div>
            <div className="component-31">
              <div className="component-27-child" />
              <div className="alapanyag4">szenhidrat</div>
            </div>
            <div className="component-32">
              <div className="component-27-child" />
              <div className="alapanyag5">gi</div>
            </div>
          </div>
          <div className="fejlc">
